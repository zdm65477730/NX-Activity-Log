...
namespace CustomScreen {
    SimpleProgressBox::SimpleProgressBox() : Aether::Screen() {
        ...
        this->bar = new Aether::RoundProgressBar(this->rect->x() + 50, this->rect->y() + 35, this->rect->w() - 160);
        this->bar->setValue(0);
        ...
        this->rect->setRectSize(this->rect->w(), (this->bar->y() + this->bar->h()) - (this->rect->y() + 35) + 75);
